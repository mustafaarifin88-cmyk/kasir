    ...
    <div class="card-body p-4 bg-light" style="border-radius: 15px;">
        <form action="<?= base_url('kasir/laporan') ?>" method="get">
            <div class="row align-items-end">
                ...
                <div class="col-md-3">
                    <button type="submit" class="btn btn-primary btn-block shadow-sm rounded-pill"><i class="fas fa-search mr-1"></i> Cari Data</button>
                </div>
            </div>
        </form>
    </div>
...
<div class="card border-0 shadow-sm mb-4" style="border-radius: 15px;">
    <div class="card-header bg-white border-0 pt-4 px-4 pb-0 d-flex justify-content-between align-items-center">
        <h5 class="font-weight-bold text-dark m-0">Rekapitulasi Gaji Karyawan</h5>
        <a href="<?= base_url('kasir/laporan/cetakPdf?id_karyawan='.$id_karyawan.'&start_date='.$start_date.'&end_date='.$end_date) ?>" target="_blank" class="btn btn-danger shadow-sm rounded-pill px-4">
    ...
    <div class="card-body p-4">
        ...
        <div class="row mt-5">
            <div class="col-md-6 offset-md-6">
                <div class="card bg-gradient-primary text-white border-0" style="background: linear-gradient(135deg, #1cc88a 0%, #13855c 100%); border-radius: 15px;">
                    <div class="card-body">
